...
class DocsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doc" do
    assert_difference('Doc.count') do
      post docs_url, params: { doc: {  description: @doc. description, student: @doc.student, materia: @doc.materia } }
    end
  ...
  test "should update doc" do
    patch doc_url(@doc), params: { doc: {  description: @doc. description, student: @doc.student, materia: @doc.materia } }
